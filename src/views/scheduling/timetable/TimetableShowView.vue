    ...
    <div class="flex items-center justify-between">
      <div class="flex items-center gap-3">
        <Button
          ...
          text
          rounded
          @click="router.push({ name: 'timetable.index' })"
        />
        <div class="flex items-center gap-3">
          ...
          <div>
            <h1 class="text-xl font-bold text-surface-900">Lihat Jadwal</h1>
    ...
    <div class="bg-white rounded-2xl border border-surface-100 shadow-sm p-6">
      <div class="flex items-center justify-center h-48 text-surface-300">
        <div class="text-center">
          ...
          <p class="text-sm">Detail Jadwal akan ditampilkan di sini</p>
        </div>
      </div>
    </div>
  </div>
